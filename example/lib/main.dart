...
class _CameraExampleHomeState extends State<CameraExampleHome>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          if(photoBytes != null)
            Image.memory(photoBytes!, scale: 10,),
          Expanded(
            child: Container(
              child: Padding(
  ...
  void onTakePictureButtonPressed() async {
    ...
    if(controller?.textureId != null) {
      photoBytes = await FlutterTextureImage.getTextureAsPng(controller!.textureId as int, 1080, 1920);
      setState(() {
...
class CameraApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return
      MaterialApp(
        theme: ThemeData(
          accentTextTheme: TextTheme(bodyMedium: TextStyle(color: Colors.white)),
        ),
